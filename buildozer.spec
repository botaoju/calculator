...
package.domain = com.calculator.app
...
# 1) android.add_assets = file1.txt,image.png,music.ogg,path/to/dir
# 2) android.add_assets.1 = path/to/file1.txt
#    android.add_assets.2 = path/to/dir2
#android.add_assets =

# (list) Put these files or directories in the apk res directory.
# The option may be used in three ways, the value may contain one or zero ':'s
# Some examples:
...
# (bool) Whether or not to fork from the main process
#android.fork_from_main = False
